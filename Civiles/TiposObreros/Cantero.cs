...
{
    public class Cantero : Ciudadano
    {
        Ciudadano  _ciudadano;  
        public Cantero(IAtacarBehavior atacarBehavior, ITrabajoBehavior trabajoBehavior, Ciudadano ciudadano) : base(atacarBehavior, trabajoBehavior)
        {
        ...
        {
            Console.WriteLine("Escarbar");
        }

        public override double recurso()
        {
            return _ciudadano.recurso() + .36;
        }
