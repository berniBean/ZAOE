...
{
    public class Cazador : Ciudadano
    {
        Ciudadano _ciudadano;
        public Cazador(IAtacarBehavior atacarBehavior, ITrabajoBehavior trabajoBehavior, Ciudadano ciudadano) : base(atacarBehavior, trabajoBehavior)
        {
