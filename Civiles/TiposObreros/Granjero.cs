...
{
    public class Granjero : Ciudadano
    {
        Ciudadano _ciudadano;
        public Granjero(IAtacarBehavior atacarBehavior, ITrabajoBehavior trabajoBehavior, Ciudadano ciudadano) : base(atacarBehavior, trabajoBehavior)
        {
        ...
        {
            Console.WriteLine("Cultivar");
        }

        public override double recurso()
        {
            return _ciudadano.recurso() + .53;
        }
