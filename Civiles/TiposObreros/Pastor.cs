...
{
    public class Pastor : Ciudadano
    {
        Ciudadano _ciudadano;
        public Pastor(IAtacarBehavior atacarBehavior, ITrabajoBehavior trabajoBehavior, Ciudadano ciudadano) : base(atacarBehavior, trabajoBehavior)
        {
        ...
        {
            Console.WriteLine("Pastar");
        }

        public override double recurso()
        {
            return _ciudadano.recurso()+ .33;
        }
