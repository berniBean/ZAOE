...
{
    public class Recolector : Ciudadano
    {
        Ciudadano _ciudadano;
        public Recolector(IAtacarBehavior atacarBehavior, ITrabajoBehavior trabajoBehavior, Ciudadano ciudadano) : base(atacarBehavior, trabajoBehavior)
        {
        ...
        {
            Console.WriteLine("Recolectar");
            
        }

        public override double recurso()
        {
            return _ciudadano.recurso() + .31;
        }
